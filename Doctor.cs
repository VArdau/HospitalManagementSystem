...
namespace HospitalManagementSystem
{
    public partial class Doctor : Form
    {
        ...
        private void bttnViewPatient_Click(object sender, EventArgs e)
        {
            ViewPatient form = new ViewPatient();
            form.Show();
        }

        private void bttnUpdatePatient_Click(object sender, EventArgs e)
        {
        ...
        {
            ViewDiagnosis form = new ViewDiagnosis(lblName.Text);
            form.Show();
        }

        private void bttnCreateDiagnosis_Click(object sender, EventArgs e)
        {
            CreateDiagnosis form = new CreateDiagnosis(lblName.Text);
            form.Show();
        }
        ...
        private void bttnViewAppointment_Click(object sender, EventArgs e)
        {
            ViewAppointment form = new ViewAppointment(lblName.Text);
            form.Show();
        }
    }
}
